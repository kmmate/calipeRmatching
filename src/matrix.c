...
void test_matrix_isequal(void){
    ...
    Rprintf("Tests for `matrix_isequal` completed: no issues found.\n");
}
...
//     assert(spmatrix_short_equal_robust(c3, res3));
//     Rprintf("Tests for `spmatrix_short_add` completed: no issues found.\n");
// }
...
void test_matrix(void){
    ...
    Rprintf("=== Tests: all tests for `matrix` completed: no issues found.\n");
}