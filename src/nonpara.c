...
void test_nonpara_h_eval_filter(void){
    ...
    // Rprintf("h_d[0] = %f, result[0] = %f\n", h_d[0], result[0]);
    // Rprintf("h_d[1] = %f, result[1] = %f\n", h_d[1], result[1]);
    ...
    free(result);
    free(h_d);
    Rprintf("Tests for `nonpara_h_eval_filter` completed: no issues found.\n");
}
...
void test_nonpara_qk_eval_filter(void){
    ...
    // Rprintf("q_d[0] = %f, result[0] = %f\n", q_d[0], result[0]);
    // Rprintf("q_d[1] = %f, result[1] = %f\n", q_d[1], result[1]);
    ...
    free(result);
    free(q_d);
    Rprintf("Tests for `nonpara_qk_eval_filter` completed: no issues found.\n");
}
...
void test_nonpara_h_deriv_eval_filter(void){
    ...
    // Rprintf("h_d_deriv[0] = %f, result[0] = %f\n", h_d_deriv[0], result[0]);
    // Rprintf("h_d_deriv[1] = %.10f, result[1] = %.10f\n", h_d_deriv[1], result[1]);
    ...
    // Rprintf("h_d_deriv[0] = %.10f, result[0] = %.10f\n", h_d_deriv[0], result[0]);
    // Rprintf("h_d_deriv[1] = %.10f, result[1] = %.10f\n", h_d_deriv[1], result[1]);
    assert( _test_nonpara_dcompare(h_d_deriv[0], result[0]) && _test_nonpara_dcompare(h_d_deriv[1],result[1]));
    ...
    free(result);
    free(h_d_deriv);
    Rprintf("Tests for `nonpara_h_deriv_eval_filter` completed: no issues found.\n");
}
...
void test_nonpara_qk_deriv_eval_filter(void){
    ...
    // Rprintf("q_d_deriv[0] = %f, result[0] = %f\n", q_d_deriv[0], result[0]);
    // Rprintf("q_d_deriv[1] = %f, result[1] = %f\n", q_d_deriv[1], result[1]);
    ...
    free(result);
    free(q_d_deriv);    
    Rprintf("Tests for `nonpara_qk_deriv_eval_filter` completed: no issues found.\n");
}
...
void test_nonpara_qk_deriv_weighted_eval_filter(void){
    ...
    free(result);
    free(q_d_deriv);
    Rprintf("Tests for `nonpara_qk_deriv_weighted_eval_filter` completed: no issues found.\n");
}
...
void test_nonpara(void){
    ...
    Rprintf("=== Tests: all tests for `nonpara` completed: no issues found.\n");
}