...
void test_vector_is_zero_one(void){
    ...
    vector_free(v);
    Rprintf("Tests for `vector_is_zero_one` completed: no issues found.\n");
}
...
void test_vector_sum(void){
    ...
    vector_free(v);
    Rprintf("Tests for `vector_sum` completed: no issues found.\n");
}
...
void test_vector_isequal(void){
    ...
    Rprintf("Tests for `vector_isequal` completed: no issues found.\n");
}
...
void test_vector_short_is_zero_one(void){
    ...
    vector_short_free(v);
    Rprintf("Tests for `vector_short_is_zero_one` completed: no issues found.\n");
}
...
void test_vector_short_sum(void){
    ...
    vector_short_free(v);
    Rprintf("Tests for `vector_short_sum` completed: no issues found.\n");
}
...
void test_vector_short_mean(void){
    ...
    // cleanup
    vector_short_free(v);
    Rprintf("Tests for `vector_short_mean` completed: no issues found.\n");
}
...
void test_vector(void){
    ...
    Rprintf("=== Tests: all tests for `vector` completed: no issues found.\n");
}