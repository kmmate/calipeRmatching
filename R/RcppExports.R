...
#'
cpp_cm_set_number_of_threads <- function(nr_threads) {
    .Call(`_calipeRmatching_cpp_cm_set_number_of_threads`, nr_threads)
}
...
#' @references [KPV23] Kormos, V. d. Pas, V. d. Vaart (2023): Asymptotics of Caliper Matching Estimators for Average Treatment Effects, https://arxiv.org/abs/2304.08373
#'
cpp_test_cm <- function() {
    .Call(`_calipeRmatching_cpp_test_cm`)
}
...
#' @references [KPV23] Kormos, V. d. Pas, V. d. Vaart (2023): Asymptotics of Caliper Matching Estimators for Average Treatment Effects, https://arxiv.org/abs/2304.08373
#'
cpp_cm_cm_known_propscore <- function(y, d, propscore, delta, estimate_variance, beta, alpha, kappa_a, kappa_gamma) {
    .Call(`_calipeRmatching_cpp_cm_cm_known_propscore`, y, d, propscore, delta, estimate_variance, beta, alpha, kappa_a, kappa_gamma)
}
...
#' 
#'
cpp_cm_cm <- function(y, d, x, modeltype, theta, delta, estimate_variance, beta, alpha, kappa_a, kappa_gamma, kappa_gamma_derivative) {
    .Call(`_calipeRmatching_cpp_cm_cm`, y, d, x, modeltype, theta, delta, estimate_variance, beta, alpha, kappa_a, kappa_gamma, kappa_gamma_derivative)
}
